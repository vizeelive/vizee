...
var ApolloLink = (function () {
    ...
    ApolloLink.prototype.request = function (operation, forward) {
        throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(11) : new invariant.InvariantError('request is not implemented');
    };
...
var serializeFetchParameter = function (p, label) {
    ...
    try {
        ...
        var parseError = process.env.NODE_ENV === "production" ? new invariant.InvariantError(12) : new invariant.InvariantError("Network request failed. " + label + " is not serializable: " + e.message);
...
var checkFetcher = function (fetcher) {
    if (!fetcher && typeof fetch === 'undefined') {
        throw process.env.NODE_ENV === "production" ? new invariant.InvariantError(13) : new invariant.InvariantError("\n\"fetch\" has not been found globally and no fetcher has been configured. To fix this, install a fetch package (like https://www.npmjs.com/package/cross-fetch), instantiate the fetcher, and pass it into your HttpLink constructor. For example:\n\nimport fetch from 'cross-fetch';\nimport { ApolloClient, HttpLink } from '@apollo/client';\nconst client = new ApolloClient({\n  link: new HttpLink({ uri: '/graphql', fetch })\n});\n    ");
    }
};
