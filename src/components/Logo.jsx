...
function Logo(props) {
  ...
  return (
    ...
    >
      ...
      {hasText && (
        <g>
          <path fill={textColor} d="M202.93,78.32c-1.2,2.95-3.17,4.7-6.13,4.7h-0.55c-2.95,0-5.03-1.75-6.34-4.7l-17.06-41c-0.88-2.41,0.43-5.58,3.17-6.23 c2.62-0.77,5.03,0.55,6.12,3.28l14.32,36.41l14.22-36.41c1.09-2.74,3.5-4.05,6.12-3.28c2.73,0.66,3.94,3.83,3.06,6.23L202.93,78.32z"/>
          <path fill={textColor} d="M235.92,6.27c3.83,0,6.89,2.73,6.89,6.45c0,3.72-3.06,6.45-6.89,6.45c-3.72,0-6.89-2.73-6.89-6.45 C229.04,9,232.21,6.27,235.92,6.27z M240.95,35.9c0-2.73-2.19-5.03-5.03-5.03c-2.73,0-4.92,2.29-4.92,5.03V78 c0,2.73,2.18,5.03,4.92,5.03c2.84,0,5.03-2.29,5.03-5.03V35.9z"/>
          <path fill={textColor} d="M283.59,40.93H259.2c-2.62,0-4.81-2.08-4.81-4.7c0-2.73,2.19-4.81,4.81-4.81h33.9c3.17,0,5.58,2.08,5.58,4.7v0.22 c0,1.97-0.77,3.5-2.41,5.36l-29.08,31.27h26.68c2.63,0,4.81,2.08,4.81,4.81c0,2.63-2.19,4.7-4.81,4.7h-35.65 c-3.17,0-5.58-2.08-5.58-4.7v-0.22c0-1.97,0.77-3.5,2.41-5.36L283.59,40.93z"/>
          <path fill={textColor} d="M353.84,60.72h-37.61c1.2,8.53,7.87,13.89,16.51,13.89c6.13,0,9.51-1.53,13.01-5.36c1.86-2.08,4.7-2.73,6.67-1.31 c1.97,1.53,2.41,4.48,0.88,6.23c-4.92,6.34-12.57,9.4-20.89,9.4c-14.54,0-26.13-10.61-26.13-26.79c0-16.18,11.59-26.46,26.13-26.46 c14.54,0,25.37,10.28,25.37,26.46C357.78,59.08,355.92,60.72,353.84,60.72z M347.94,52.95c-1.2-8.53-7.33-13.67-15.53-13.67 c-8.42,0-14.98,5.14-16.18,13.67H347.94z"/>
          <path fill={textColor} d="M414.06,60.72h-37.62c1.2,8.53,7.87,13.89,16.51,13.89c6.13,0,9.51-1.53,13.01-5.36c1.86-2.08,4.7-2.73,6.67-1.31 c1.97,1.53,2.41,4.48,0.88,6.23c-4.92,6.34-12.58,9.4-20.89,9.4c-14.54,0-26.13-10.61-26.13-26.79c0-16.18,11.59-26.46,26.13-26.46 c14.54,0,25.37,10.28,25.37,26.46C418,59.08,416.14,60.72,414.06,60.72z M408.16,52.95c-1.2-8.53-7.33-13.67-15.53-13.67 c-8.42,0-14.98,5.14-16.18,13.67H408.16z"/>
        </g>
      )}
    </Svg>
  );
